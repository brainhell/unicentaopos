...
public class DeviceScale {
    ...
    public DeviceScale(Component parent, AppProperties props) {
        ...
        switch (sScaleType) {
            ...
            case "samsungesp":
                ...
                break;
            case "andeki":      // 01-02-2014 De Kruidenier - Support for AND EK-i series
                m_scale = new ScaleANDEKi(sScaleParam1, parent);
                break;
            case "fake":
    ...
    public Double readWeight(ProductInfoExt prod) throws ScaleException {
        ...
        if (m_scale == null) {
            ...
            Double result = m_scale.readWeight(prod);       // 2014-02-14 by De Kruidenier - Add product
