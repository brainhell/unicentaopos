...
// JG May 2013 replaced with Multicatch
    ...
    private void incProduct(ProductInfoExt prod) {
        ...
        if (prod.isScale() && m_App.getDeviceScale().existsScale()) {
            try {
                Double value = m_App.getDeviceScale().readWeight(prod);
                if (value != null) {
            ...
            if (cTrans == '\u007f') { 
                ...
                if (m_App.getDeviceScale().existsScale() && m_App.getAppUserView().getUser().hasPermission("sales.EditLines")) {
                    try {
                        ...
                        Double value = m_App.getDeviceScale().readWeight(product);
                        if (value != null) {
                            //ProductInfoExt product = getInputProduct();
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        m_jTicketId.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
