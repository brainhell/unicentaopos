...
//     
        ...
        attributes.setProperty("product.isscale", product.isScale() ? "true" : "false");
...
// ADDED 01-02-2014 De Kruidenier - Is Scale product
public boolean isScale() {
	return "true".equals(attributes.getProperty("product.isscale"));
//
